...
class Decoder(nn.Module):
    ...
    def __init__(self, dims, dim, class_num=2):
        ...
        self.linear_fuse = ConvModule(in_channels=embedding_dim * 3, out_channels=embedding_dim, kernel_size=1,
...
class cvt_SD(nn.Module):
    def __init__(self, class_num=2, **kwargs):
        super(cvt_SD, self).__init__()
        self.class_num = class_num
        ######################################load_weight
        self.backbone = model
        #####################################
        self.decode_head = Decoder(dims=[64, 192, 384], dim=768, class_num=class_num)
...
class cvt_b2_256(nn.Module):
    def __init__(self, class_num=2, **kwargs):
        super(cvt_b2_256, self).__init__()
        self.class_num = class_num
        ######################################load_weight
        self.backbone = model
        #####################################
        self.decode_head = Decoder(dims=[64, 192, 384], dim=256, class_num=class_num)
